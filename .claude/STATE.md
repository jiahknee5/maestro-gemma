...
- [x] Subtask 0 — Infra: Xcode project scaffold + Cactus integration + Ollama client + routing
- [x] Subtask 1 — Practice Screen: camera + posture + pitch + coaching overlay
- [x] Subtask 2 — Ask Coach: free-text modal + Ollama routing + fallback
- [x] Subtask 3 — Session Intelligence: recording + summary + practice plan
- [x] Subtask 4 — Teacher Report: structured export + share sheet
